          ...
          {filteredCommands.length > 0 ? (
            ...
            <div className="p-8 text-center text-[var(--muted-foreground)]">
              ...
              <p className="text-xs mt-1">
                Try searching for "track", "AI", or "export"
              </p>
            </div>
          )}
        </div>
        ...
        <div className="p-3 border-t border-[var(--border)] bg-[var(--muted)] rounded-b-xl">
          <div className="flex items-center justify-between text-xs text-[var(--muted-foreground)]">
            <div className="flex items-center space-x-4">
              <span>
                <kbd className="px-2 py-1 bg-[var(--secondary)] border border-[var(--border)] rounded">
                  ↑↓
                </kbd>
          ...
          <div className="flex items-center space-x-2">
            ...
            {isEditingName ? (
              <input
                ...
                autoFocus
                style={{
                  width: `${Math.max(projectName.length * 8 + 20, 120)}px`,
                }}
              />
            ) : (
              <span
                ...
                <div className="p-2 border-b border-[var(--border)] bg-[var(--muted)]/20">
                  <div className="flex space-x-1">
                    <Button
                      variant="ghost"
                      size="sm"
                      className="h-7 px-3 text-xs bg-[var(--primary)] text-[var(--primary-foreground)]"
                    >
                      All
                    </Button>
                    <Button
                ...
                <div className="max-h-96 overflow-y-auto">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm font-medium text-[var(--foreground)]">
                          AI Master Processing Complete
                        </div>
                        <div className="text-xs text-[var(--muted-foreground)] mt-1">
                          Your track "Ambient Journey" has been enhanced with AI
                          mastering. Ready for review.
                        </div>
                  ...
                  <div className="p-3 border-b border-[var(--border)] hover:bg-[var(--muted)]/30 cursor-pointer">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="text-sm font-medium text-[var(--foreground)]">
                          Sarah joined your session
                        </div>
                        <div className="text-xs text-[var(--muted-foreground)] mt-1">
                          Sound Engineer Sarah is now collaborating on
                          "Electronic Dreams"
                        </div>
                  ...
                  <div className="p-3 border-b border-[var(--border)] hover:bg-[var(--muted)]/30 cursor-pointer">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-[var(--muted-foreground)] mt-1">
                          Peak levels detected in "Drum Track 1" at 2:34.
                  ...
                  <div className="p-3 border-b border-[var(--border)] hover:bg-[var(--muted)]/30 cursor-pointer">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-[var(--muted-foreground)] mt-1">
                          Try adding reverb to "Vocal Track" for more
                          atmospheric depth
                        </div>
                        <div className="flex items-center space-x-2 mt-2">
                          <Button
                  ...
                  <div className="p-3 hover:bg-[var(--muted)]/30 cursor-pointer">
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-[var(--muted-foreground)] mt-1">
                          New AI audio enhancement features and bug fixes
                          available
                        </div>
                        <div className="flex items-center space-x-2 mt-2">
                          <Button
