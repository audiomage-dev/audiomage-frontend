  ...
  useEffect(() => {
    ...
    for (let i = samples - 1; i >= 0; i--) {
      ...
      const amplitude = Math.max(
        0,
        Math.min(1, baseAmplitude * (0.7 + frequency + noise))
      );
      const waveHeight = amplitude * (height * 0.4);
...
function SpectrogramDisplay({ track }: SpectrogramDisplayProps) {
    ...
    for (let t = 0; t < timeSlices; t++) {
      for (let f = 0; f < frequencyBins; f++) {
        ...
        // High frequencies (cymbals, harmonics)
          ...
          magnitude =
            trackVolume *
            (0.3 + Math.sin(t * 0.08 + f * 0.01) * 0.2) *
            (1 - frequency / 22050);
        }
  ...
  const handleClick = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    if (frequency < 250) {
      ...
      magnitude =
        trackVolume * (0.6 + Math.sin(time * 5 + frequency * 0.002) * 0.4);
    } else {
      magnitude =
        trackVolume *
        (0.3 + Math.sin(time * 8 + frequency * 0.001) * 0.2) *
        (1 - frequency / 22050);
    }
...
export function TrackInspector({
  ...
  const [activeTab, setActiveTab] = useState<
    'mixer' | 'effects' | 'eq' | 'sends' | 'wavelets'
  >('mixer');
  ...
  const extractWavelets = async () => {
    ...
    try {
      ...
      const frequency = track.name.toLowerCase().includes('bass')
        ? 80
      ...
      const totalEnergy = coefficients.reduce(
        (sum, level) => sum + level.energy,
        0
      );
      const dominantLevel = coefficients.reduce(
        (prev, curr) => (curr.energy > prev.energy ? curr : prev),
        coefficients[0]
      );
      ...
      const waveletResults = {
        ...
        statistics: {
          ...
          compressionRatio: (
            (coefficients.reduce(
              (sum, level) =>
                sum + level.detail.filter((c) => Math.abs(c) > 0.1).length,
              0
            ) /
              samples) *
            100
  ...
  const playWaveletAudio = async (waveletEntry: any) => {
    ...
    try {
      ...
      for (
        let i = 0;
        i < Math.min(reconstructed.length, currentLevel.length);
        i++
      ) {
        ...
        {activeTab === 'mixer' && (
          <div className="flex flex-col lg:flex-row min-h-full">
            ...
            <div className="w-full lg:w-20 border-b lg:border-b-0 lg:border-r border-[var(--border)] p-2 flex-shrink-0">
              <h4 className="text-xs font-medium text-[var(--muted-foreground)] mb-2 text-center">
                Levels
              </h4>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setVisualizationMode((prev) =>
                        prev === 'waveform' ? 'spectrogram' : 'waveform'
                      )
                    }
                  >
              ...
              {waveletData && (
                <div className="mt-4 p-3 bg-[var(--muted)] rounded-md">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-xs mb-3">
                    <div>
                      ...
                      <div className="font-mono">
                        {waveletData.statistics.totalEnergy}
                      </div>
                    </div>
                    <div>
                      <div className="text-[var(--muted-foreground)]">
                      ...
                      <div className="font-mono">
                        Level {waveletData.statistics.dominantLevel}
                      </div>
                    </div>
                    <div>
                      <div className="text-[var(--muted-foreground)]">
                      ...
                      <div className="font-mono">
                        {waveletData.statistics.dominantFrequency}
                      </div>
                    </div>
                    <div>
                      <div className="text-[var(--muted-foreground)]">
                      ...
                      <div className="font-mono">
                        {waveletData.statistics.compressionRatio}%
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-2 text-xs text-[var(--muted-foreground)]">
                    Extracted{' '}
                    {new Date(waveletData.extractionTime).toLocaleTimeString()}
                  </div>
                </div>
              )}
            ...
            <div className="space-y-2">
              {track.effects?.length > 0 ? (
                track.effects.map((effect) => (
                  <div
                    key={`track-${track.id}-effect-${effect.id}`}
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <div
                          className={`w-2 h-2 rounded-full ${effect.enabled ? 'bg-[var(--green)]' : 'bg-[var(--muted-foreground)]'}`}
                        />
                    ...
                    return (
                      <g key={freq}>
                        <line
                          ...
                          strokeWidth="0.5"
                          opacity={
                            [100, 1000, 10000].includes(freq) ? '0.6' : '0.3'
                          }
                        />
                        <text
                          x={x}
          ...
          <div className="p-4">
            ...
            <div className="space-y-4">
              {['Reverb A', 'Delay B', 'Chorus C'].map((send, index) => (
                <div
                  key={send}
                  className="flex items-center space-x-4 p-3 bg-[var(--muted)] rounded-md"
                >
        ...
        {activeTab === 'wavelets' && (
          <div className="p-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-xs text-[var(--muted-foreground)]">
                {allWavelets.length} analysis
                {allWavelets.length !== 1 ? 'es' : ''}
              </div>
            </div>
            ...
            {allWavelets.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-sm font-medium">
                          {waveletEntry.trackName}
                        </span>
                        <span className="text-xs text-[var(--muted-foreground)]">
                          {new Date(
                            waveletEntry.extractionTime
                          ).toLocaleTimeString()}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Button
                          ...
                          onClick={() => {
                            setAllWavelets((prev) =>
                              prev.filter((w) => w.id !== waveletEntry.id)
                            );
                          }}
                        >
                          <X className="w-3 h-3" />
                    ...
                    <div className="grid grid-cols-2 gap-3 text-xs mb-3">
                      <div>
                        ...
                        <div className="font-mono">
                          {waveletEntry.data.statistics.totalEnergy}
                        </div>
                      </div>
                      <div>
                        <div className="text-[var(--muted-foreground)]">
                        ...
                        <div className="font-mono">
                          Level {waveletEntry.data.statistics.dominantLevel}
                        </div>
                      </div>
                      <div>
                        <div className="text-[var(--muted-foreground)]">
                        ...
                        <div className="font-mono">
                          {waveletEntry.data.statistics.dominantFrequency}
                        </div>
                      </div>
                      <div>
                        <div className="text-[var(--muted-foreground)]">
                        ...
                        <div className="font-mono">
                          {waveletEntry.data.statistics.compressionRatio}%
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-1">
                      ...
                      {waveletEntry.data.coefficients
                        .slice(0, 4)
                        .map((level: any, index: number) => (
                          <div
                            ...
                            className="flex items-center space-x-2"
                          >
                            <div className="w-6 text-xs font-mono">
                              L{level.level}
                            </div>
                      ...
                      {waveletEntry.data.coefficients.length > 4 && (
                        <div className="text-xs text-[var(--muted-foreground)] pl-8">
                          +{waveletEntry.data.coefficients.length - 4} more
                          levels
                        </div>
                      )}
                    </div>
              ...
              <div className="text-center py-8 text-[var(--muted-foreground)]">
                ...
                <div className="text-xs opacity-70">
                  Extract wavelets from audio tracks to see them here
                </div>
              </div>
            )}
          </div>
