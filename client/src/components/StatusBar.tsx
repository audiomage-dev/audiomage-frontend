  ...
  return (
    <div className="bg-[hsl(var(--muted))] border-t border-[hsl(var(--border))] px-3 py-1 flex items-center justify-between text-xs">
      <div className="flex items-center space-x-4">
        ...
        <span
          className={`flex items-center space-x-1 ${isSaved ? 'text-[hsl(var(--aurora-green))]' : 'text-[hsl(var(--aurora-orange))]'}`}
        >
          <span>●</span>
      ...
      <div className="flex items-center space-x-4">
        <div className="flex items-center space-x-1">
          <span>LUFS:</span>
          <span className="font-mono text-[hsl(var(--frost-2))]">
            {aiAnalysis.lufs}
          </span>
        </div>
        <div className="flex items-center space-x-1">
          <span>Peak:</span>
          <span className="font-mono text-[hsl(var(--aurora-yellow))]">
            {aiAnalysis.peak}dB
          </span>
        </div>
        <div className="flex items-center space-x-1">
          ...
          <span
            className={
              aiAnalysis.isProcessing
                ? 'text-[hsl(var(--aurora-yellow))]'
                : 'text-[hsl(var(--aurora-green))]'
            }
          >
