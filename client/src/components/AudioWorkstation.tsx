        ...
        <div className="flex-1 flex min-w-0">
          ...
          >
            ...
            <div className="flex-1 flex flex-row items-stretch justify-center gap-1 w-full">
              ...
              {/* Interactive Master Fader - Centered between meters */}
              <div className="w-4 bg-[var(--card)] border border-[var(--border)] rounded-full relative shadow-sm mx-1">
                {/* Fader Track */}
                ...
                <div 
                  className="absolute w-3 h-3 bg-gradient-to-b from-blue-400 to-blue-600 border-2 border-blue-300 rounded cursor-grab active:cursor-grabbing shadow-lg hover:shadow-xl transition-all hover:scale-105 select-none"
                  style={{ 
                    top: '25%',
                    left: '50%',
              ...
              {/* Combined Scale for both meters and fader */}
              <div className="ml-1 flex flex-col justify-between text-[6px] text-[var(--foreground)] font-mono font-bold py-1 bg-[var(--background)]/80 rounded px-1">
                <span className="text-red-500">+6/0</span>
                <span className="text-yellow-600">0/-6</span>
                <span className="text-green-600">-6/-12</span>
                <span className="text-green-700">-12/-24</span>
