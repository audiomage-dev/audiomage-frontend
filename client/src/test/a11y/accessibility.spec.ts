...
test.describe('Accessibility Tests', () => {
  ...
  test('should not have any automatically detectable accessibility issues on studio page', async ({
    page,
  }) => {
  ...
  test('should support keyboard navigation in audio workstation', async ({
    page,
  }) => {
    await page.goto('/studio');
    ...
    const previousFocused = await page
      .locator(':focus')
      .getAttribute('data-testid');
